...
export const RESIDENTIAL_SERVICES: HomepageService[] = [
  ...
  { id: 'refrigerator',         name: 'Refrigerator Repair',     desc: 'Same day service · OEM parts on every truck · Sub-Zero, Viking, Thermador, Samsung, LG. Compressor, sensor, ice-maker.', photoCaption: 'Photo · Sub-Zero Built-In Refrigerator', category: 'residential' },
...
export const COMMERCIAL_SERVICES: HomepageService[] = [
  ...
  { id: 'walk-in-cooler',       name: 'Walk-In Cooler',          desc: 'Commercial certified · Calls answered 24/7, same-day for most repairs · True, Kolpak, Nor-Lake, Master-Bilt. Compressor, evaporator, defrost timer, door seal.', photoCaption: 'Photo · True Walk-In Cooler Box', category: 'commercial' },
