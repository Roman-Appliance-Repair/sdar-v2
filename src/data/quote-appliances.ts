...
export const COMMERCIAL_APPLIANCES: ApplianceType[] = [
  ...
  },
  {
    ...
    problems: [
      ...
      'Constant flare-ups',
      'Radiants or briquettes damaged',
      'Thermostat not responding',
      ELSE,
    ],
  },
  ...
  },
  {
    ...
    problems: [
      "Won't start",
      'Blade not turning',
      'Blade dull or chipped',
      "Bowl or lid won't lock",
      'Safety interlock fault',
      'Motor overheating',
      'Grinding noise',
      'Trips the breaker',
      'Feed chute jammed',
      'Leaking from the bowl',
      ELSE,
    ],
  },
  {
...
export const APPLIANCE_SOURCES: Record<string, string[]> = {
  ...
  grill_charbroiler: ['commercial-grill-repair'],
  holding_cabinet: ['commercial-holding-cabinet-repair'],
  proofer: ['commercial-proofer-repair'],
  mixer: ['commercial-mixer-repair'],
  // No catalog slug for these three — the /commercial/ page trees are the source.
  kettle: ['commercial:kettle-repair'],
  food_processor: ['commercial:food-processor-repair'],
  slicer: ['commercial:slicer-repair'],
  commercial_range_hood: ['commercial-range-hood-repair'],
