...
| ~329 page titles >60 chars | commercial/ 154, services/ 71, outdoor/ 48, остальное 56 (brands/ закрыт Wave 39 Phase 2A) | P2 — Wave 39 Phase 2B manual rewrite (audit-output/wave-39-phase2-candidates.txt) |
