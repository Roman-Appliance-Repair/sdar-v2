...
| ~175 page titles >60 chars | services/ 71, outdoor/ 48, остальное 56 (brands/ + commercial/ закрыты Wave 39 Phase 2A+2B) | P2 — Wave 39 Phase 2C manual rewrite (audit-output/wave-39-phase2-candidates.txt) |
