...
### 1.2 Логистика запчастей — не утверждаем ни для одного производителя (2026-09-16)

Мы не знаем, откуда физически отгружаются запчасти **ни одного** производителя, через какие
склады и дистрибьюторов они идут и общие ли они у брендов одного владельца. Поэтому на страницах
этого не пишем — ни про бытовые, ни про коммерческие, ни про уличные бренды:

- ❌ город / штат / страна как место отгрузки или склад («ships from Troy, Ohio», «Irvine CA
  parts warehouse», «Winston-Salem NC parts pipeline»);
- ❌ «parts infrastructure / network / channel / chain / pipeline / distribution» производителя
  или владельца как наше преимущество («through Middleby distribution», «Ali Group parts channel»);
- ❌ общие запчасти или общий канал поставки у брендов одного владельца («shared parts chain»,
  «single parts supply channel»);
- ❌ сравнение наших сроков с чужими брендами без наших же замеров по этим брендам.

✅ Допустимо только то, что знаем по своим заказам: **срок поставки** («редкие позиции обычно
3–7 дней»), и то, что запчасть у нас на машине. Место производства (завод) — это факт о бренде,
не логистика; его можно называть, но не выводить из него скорость запчастей.
