// scripts/wire-c2-w8.mjs
// Wave 8 — convert the text-only dark hero (`<section class="hero">…</section>`)
// of the brand pages into the jackson-style full-bleed ServiceHero (MODE A picks up
// the deployed photo automatically). Same canonical end-state as wave 3-7 pages.
// Idempotent — skips pages already on ServiceHero (whirlpool-cooktop-repair,
// u-line-outdoor-refrigerator-repair, perlick-outdoor-refrigerator-repair → photo only).
//
...
const SLUGS = [
  'whirlpool-range-repair','whirlpool-wall-oven-repair','whirlpool-cooktop-repair','whirlpool-microwave-repair',
  'whirlpool-range-hood-repair','whirlpool-ice-maker-repair',
  'jennair-wall-oven-repair','jennair-range-hood-repair','jennair-microwave-repair','jennair-trash-compactor-repair',
  'smeg-stove-repair','smeg-dishwasher-repair','smeg-wall-oven-repair',
  'signature-kitchen-suite-wall-oven-repair','signature-kitchen-suite-dishwasher-repair','signature-kitchen-suite-range-hood-repair',
  'fisher-paykel-wall-oven-repair','fisher-paykel-washer-repair','ge-monogram-wall-oven-repair',
  'ilve-wall-oven-repair','ilve-range-hood-repair','marvel-refrigerator-repair',
  'u-line-refrigerator-repair','u-line-wine-cooler-repair','u-line-outdoor-refrigerator-repair',
  'perlick-refrigerator-repair','perlick-outdoor-refrigerator-repair',
  'true-residential-built-in-refrigerator-repair','true-residential-wine-cooler-repair','weber-grill-repair',
];
...
for (const slug of SLUGS) {
  ...
  if (src.includes('<ServiceHero')) { summary.push(`${slug.padEnd(46)} already ServiceHero — skip`); continue; }
  ...
  summary.push(`${slug.padEnd(46)} logo=${(logo || '—').padEnd(16)} crumb+=${!hadNavCrumbs && crumbInner ? 'yes' : 'no '}  eyebrow=${eyebrow || '—'}`);
