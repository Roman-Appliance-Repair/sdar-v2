// scripts/wire-c2-w10.mjs
// Wave 10 (FINAL) — convert the text-only dark hero (`<section class="hero">…</section>`)
// of the last brand pages into the jackson-style full-bleed ServiceHero (MODE A picks up
// the deployed photo automatically). Same canonical end-state as wave 3-9 pages.
// Idempotent — skips pages already on ServiceHero (champion, hobart,
// whisperkool-wine-cellar-repair → photo only).
//
...
const SLUGS = [
  'champion','heatcraft-condensing-unit-repair','hobart','imperial-oven-repair','imperial-range-repair',
  'kratos-oven-repair','lang-oven-repair','mainstreet-equipment-oven-repair','true',
  'perlick-draft-beer-system-repair','whisperkool-wine-cellar-repair','wine-guardian-repair',
  'magic-chef-oven-repair','magic-chef-stove-repair','magic-chef-wall-oven-repair',
  'roper-dishwasher-repair','roper-refrigerator-repair','speed-queen-washer-dryer-repair',
  'napoleon-grill-repair','zephyr-range-hood-repair',
];
