...
export default defineConfig({
  ...
  redirects: {
    ...
    '/brands/fisher-paykel/fisher-paykel-dryer-repair/': '/brands/fisher-paykel/',
    '/brands/frigidaire/frigidaire-refrigerator-repair/': '/brands/frigidaire-refrigerator-repair/',
    '/brands/gaggenau/gaggenau-refrigerator-repair/': '/brands/gaggenau-built-in-refrigerator-repair/',
    ...
    // 'vent hood' synonym of 'exhaust hood' — consolidate to existing exhaust-hood page (pos 6 on both queries, 3,775 imp/14d).
    '/price-list/commercial-vent-hood-repair-cost/': '/price-list/commercial-exhaust-hood-repair-cost/',
